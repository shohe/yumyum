/*! multiparty.min.js build:1.0.0, production. Copyright(c) 2014 Kensaku Komatsu <kensaku.komatsu@gmail.com> */
(function(e) {
	! function(t) {
		function i() {
		...
		function u(e, t, n, r) {
			if (!n) return [];
			var i = [],
				s, o, a, f, l, c, h, p = t.length,
				d = t[r],
				v = t[r + 1];
			if (r === p && n._listeners) {
				if (typeof n._listeners == "function") return e && e.push(n._listeners), [n];
				for (s = 0, o = n._listeners.length; s < o; s++) e && e.push(n._listeners[s]);
				return [n]
			}
			if (d === "*" || d === "**" || n[d]) {
				if (d === "*") {
					for (a in n) a !== "_listeners" && n.hasOwnProperty(a) && (i = i.concat(u(e, t, n[a], r + 1)));
					return i
				}
				if (d === "**") {
					h = r + 1 === p || r + 2 === p && v === "*", h && n._listeners && (i = i.concat(u(e, t, n, p)));
					for (a in n) a !== "_listeners" && n.hasOwnProperty(a) && (a === "*" || a === "**" ? (n[a]._listeners && !h && (i = i.concat(u(e, t, n[a], p))), i = i.concat(u(e, t, n[a], r))) : a === v ? i = i.concat(u(e, t, n[a], r + 2)) : i = i.concat(u(e, t, n[a], r)));
					return i
				}
				i = i.concat(u(e, t, n[d], r + 1))
			}
			f = n["*"], f && u(e, t, f, r + 1), l = n["**"];
			if (l)
				if (r < p) {
					l._listeners && u(e, t, l, p);
					for (a in l) a !== "_listeners" && l.hasOwnProperty(a) && (a === v ? u(e, t, l[a], r + 2) : a === d ? u(e, t, l[a], r + 1) : (c = {}, c[a] = l[a], u(e, t, {
						"**": c
					}, r + 1)))
		...
		function a(e, t) {
			e = typeof e == "string" ? e.split(this.delimiter) : e.slice();
			for (var i = 0, s = e.length; i + 1 < s; i++)
				if (e[i] === "**" && e[i + 1] === "**") return;
			...
			while (u) {
				o[u] || (o[u] = {}), o = o[u];
				if (e.length === 0) {
					if (!o._listeners) o._listeners = t;
					else if (typeof o._listeners == "function") o._listeners = [o._listeners, t];
					else if (n(o._listeners)) {
						o._listeners.push(t);
						if (!o._listeners.warned) {
							var a = r;
							typeof this._events.maxListeners != "undefined" && (a = this._events.maxListeners), a > 0 && o._listeners.length > a && (o._listeners.warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", o._listeners.length), console.trace())
						}
					}
					return !0
				}
		...
		var n = Array.isArray ? Array.isArray : function(t) {
			...
			r = 10;
		o.prototype.delimiter = ".", o.prototype.setMaxListeners = function(e) {
			this._events || i.call(this), this._events.maxListeners = e, this._conf || (this._conf = {}), this._conf.maxListeners = e
		}, o.prototype.event = "", o.prototype.once = function(e, t) {
			return this.many(e, 1, t), this
		}, o.prototype.many = function(e, t, n) {
			function i() {
				--t === 0 && r.off(e, i), n.apply(this, arguments)
			}
			var r = this;
			if (typeof n != "function") throw new Error("many only accepts instances of Function");
			return i._origin = n, this.on(e, i), r
		}, o.prototype.emit = function() {
			this._events || i.call(this);
			var e = arguments[0];
			if (e === "newListener" && !this.newListener && !this._events.newListener) return !1;
			if (this._all) {
				var t = arguments.length,
					n = new Array(t - 1);
				for (var r = 1; r < t; r++) n[r - 1] = arguments[r];
				for (r = 0, t = this._all.length; r < t; r++) this.event = e, this._all[r].apply(this, n)
			}
			if (e === "error" && !this._all && !this._events.error && (!this.wildcard || !this.listenerTree.error)) throw arguments[1] instanceof Error ? arguments[1] : new Error("Uncaught, unspecified 'error' event.");
			var s;
			if (this.wildcard) {
				s = [];
				var o = typeof e == "string" ? e.split(this.delimiter) : e.slice();
				u.call(this, s, o, this.listenerTree, 0)
			} else s = this._events[e];
			if (typeof s == "function") {
				this.event = e;
				if (arguments.length === 1) s.call(this);
			...
			if (s) {
				...
				for (var r = 1; r < t; r++) n[r - 1] = arguments[r];
				var a = s.slice();
				for (var r = 0, t = a.length; r < t; r++) this.event = e, a[r].apply(this, n);
				return a.length > 0 || !!this._all
			}
			return !!this._all
		}, o.prototype.on = function(e, t) {
			if (typeof e == "function") return this.onAny(e), this;
			if (typeof t != "function") throw new Error("on only accepts instances of Function");
			this._events || i.call(this), this.emit("newListener", e, t);
			if (this.wildcard) return a.call(this, e, t), this;
			if (!this._events[e]) this._events[e] = t;
			else if (typeof this._events[e] == "function") this._events[e] = [this._events[e], t];
			else if (n(this._events[e])) {
				this._events[e].push(t);
				if (!this._events[e].warned) {
					var s = r;
					typeof this._events.maxListeners != "undefined" && (s = this._events.maxListeners), s > 0 && this._events[e].length > s && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), console.trace())
				}
			}
			return this
		}, o.prototype.onAny = function(e) {
			if (typeof e != "function") throw new Error("onAny only accepts instances of Function");
			return this._all || (this._all = []), this._all.push(e), this
		}, o.prototype.addListener = o.prototype.on, o.prototype.off = function(e, t) {
			...
			for (var o = 0; o < i.length; o++) {
				...
				if (n(r)) {
					...
					for (var l = 0, c = r.length; l < c; l++)
						if (r[l] === t || r[l].listener && r[l].listener === t || r[l]._origin && r[l]._origin === t) {
							f = l;
							break
						}
					if (f < 0) continue;
					return this.wildcard ? a._listeners.splice(f, 1) : this._events[e].splice(f, 1), r.length === 0 && (this.wildcard ? delete a._listeners : delete this._events[e]), this
				}
				if (r === t || r.listener && r.listener === t || r._origin && r._origin === t) this.wildcard ? delete a._listeners : delete this._events[e]
			}
			return this
		}, o.prototype.offAny = function(e) {
			var t = 0,
				n = 0,
				r;
			if (e && this._all && this._all.length > 0) {
				...
				for (t = 0, n = r.length; t < n; t++)
					if (e === r[t]) return r.splice(t, 1), this
			} else this._all = [];
			return this
		}, o.prototype.removeListener = o.prototype.off, o.prototype.removeAllListeners = function(e) {
			if (arguments.length === 0) return !this._events || i.call(this), this;
			if (this.wildcard) {
				var t = typeof e == "string" ? e.split(this.delimiter) : e.slice(),
					n = u.call(this, null, t, this.listenerTree, 0);
			...
			if (this.wildcard) {
				var t = [],
					r = typeof e == "string" ? e.split(this.delimiter) : e.slice();
				return u.call(this, t, r, this.listenerTree, 0), t
			}
			return this._events || i.call(this), this._events[e] || (this._events[e] = []), n(this._events[e]) || (this._events[e] = [this._events[e]]), this._events[e]
		}, o.prototype.listenersAny = function() {
			return this._all ? this._all : []
		}, typeof define == "function" && define.amd ? define(function() {
			return o
		}) : typeof e == "object" ? e.EventEmitter2 = o : window.EventEmitter2 = o
	}();
	var t = {
		MD5: {
			int2hex8_Fx: function(e) {
				return this.int2hex8(e[1] * 65536 + e[0])
			},
			update_Fx: function(e, t) {
				var n = this.a_[0],
					r = this.a_[1],
					i = this.b_[0],
					s = this.b_[1],
			...
			main: function(e, t, n, r, i) {
				if (i == 1) {
					var s = t * 8;
					while (t >= 64) r[n](e, i), e = e.substr(64), t -= 64;
					e += "\u0080", t >= 56 ? (e += this.fillzero(63 - t), r[n](e, i), e = this.fillzero(56)) : e += this.fillzero(55 - t), e += String.fromCharCode(s & 255, s >>> 8 & 255, s >>> 16 & 255, s >>> 24), e += "\0\0\0\0", r[n](e, i)
				} else {
					var s = t * 16;
					while (t >= 32) r[n](e, i), e = e.substr(32), t -= 32;
					e += "\u0080", t >= 28 ? (e += this.fillzero(31 - t), r[n](e, i), e = this.fillzero(28)) : e += this.fillzero(27 - t), e += String.fromCharCode(s & 65535, s >>> 16), e += "\0\0", r[n](e, i)
				}
			},
			VERSION: "1.0",
			BY_ASCII: 0,
			BY_UTF16: 1,
			calc_Fx: function(e, t) {
				var n = arguments.length == 2 && t == this.BY_UTF16 ? 2 : 1;
				return this.a_ = [8961, 26437], this.b_ = [43913, 61389], this.c_ = [56574, 39098], this.d_ = [21622, 4146], this.main(e, e.length, "update_Fx", this, n), this.int2hex8_Fx(this.a_) + this.int2hex8_Fx(this.b_) + this.int2hex8_Fx(this.c_) + this.int2hex8_Fx(this.d_)
			},
			calc_std: function(e, t) {
				var n = arguments.length == 2 && t == this.BY_UTF16 ? 2 : 1;
				return this.a_ = 1732584193, this.b_ = 4023233417, this.c_ = 2562383102, this.d_ = 271733878, this.main(e, e.length, "update_std", this, n), this.int2hex8(this.a_) + this.int2hex8(this.b_) + this.int2hex8(this.c_) + this.int2hex8(this.d_)
			}
		}
	};
	new function() {
		t.MD5.calc = navigator.userAgent.match(/Firefox/) ? t.MD5.calc_Fx : t.MD5.calc_std
	},
	function(e) {
		navigator.getUserMedia_ = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia, window.AudioContext = window.AudioContext || window.webkitAudioContext;
		var n = function(e) {
			this.room = null, this.id = null, this.key = null, this.peers = {}, this.stream = null, this.tracks_ = {}, this.gainNode_, this.pollInterval = null, this.opened = !1, this.opts = n.util.checkOpts_(e)
		};
		n.prototype = new EventEmitter2, n.prototype.conn2SkyWay_ = function() {
			var e = this;
			this.peer = new Peer(this.opts.id, this.opts.peerjs_opts), this.peer.on("open", function(e) {
				if (this.opened) throw "Error : connection to SkyWay is already opened";
				this.opened = !0;
				if (e !== this.opts.id) throw "Error : SkyWay returns wrong peer id for myself";
				this.fire_("open", e), this.getIDs_(), this.opts.polling && this.startPollingConnections_()
			}.bind(this)), this.peer.on("error", function(t) {
				e.fire_("error", t)
			})
		}, n.prototype.getIDs_ = function() {
			var e = this;
			e.listAllPeers(function(t) {
				t.forEach(function(t) {
					e.peers[t] = {}
				}), e.opts.use_stream && e.startMediaStream_(), e.startDataChannel_()
			})
		}, n.prototype.startPollingConnections_ = function() {
			var e = this;
			e.pollInterval = setInterval(function() {
				e.listAllPeers(function(t) {
					for (var n in e.peers) {
						var r = !0;
						...
						if (r) e.removePeer(n);
							...
							var i = multiparty.peers[n],
								s = {
									video: i.call ? !i.call.open : !1,
									screen: i.screen_sender ? !i.screen_sender.open : !1,
									data: i.DCconn ? !i.DCconn.open : !1
								};
							s.video || s.screen || s.data ? (i.reconnectIndex_ ? i.reconnectIndex_++ : i.reconnectIndex_ = 1, (i.reconnectIndex_ & i.reconnectIndex_ - 1) == 0 && e.reconnect(n, s)) : i.reconnectIndex_ = 0
						}
					}
				})
			}, e.opts.polling_interval)
		}, n.prototype.startMediaStream_ = function() {
			this.startMyStream_()
		}, n.prototype.startMyStream_ = function() {
			var e = this;
			navigator.getUserMedia_({
				video: e.opts.video_stream,
				audio: e.opts.audio_stream
			}, function(t) {
				var n = new AudioContext;
				e.gainNode_ = n.createGain();
				var r = n.createMediaStreamSource(t),
					i = n.createMediaStreamDestination();
				i.stream.addTrack ? (r.connect(e.gainNode_), e.gainNode_.connect(i), t.getVideoTracks() && i.stream.addTrack(t.getVideoTracks()[0]), e.stream = i.stream) : e.stream = t, e.opts.video_stream && (e.tracks_.video = e.stream.getVideoTracks()[0]), e.opts.audio_stream && (e.tracks_.audio = e.stream.getAudioTracks()[0]), e.fire_("my_ms", {
		...
		}, n.prototype.mute = function(e) {
			if (e === undefined) {
				this.tracks_.audio.enabled = !1, this.tracks_.video.enabled = !1, this.gainNode_ !== undefined && (this.gainNode_.gain.value = 0);
				return
			}
			e.audio !== undefined && e.audio === !0 && (this.tracks_.audio.enabled = !1, this.tracks_.audio.muted = !0, this.gainNode_ !== undefined && (this.gainNode_.gain.value = 0)), e.video !== undefined && e.video === !0 && (this.tracks_.video.enabled = !1)
		}, n.prototype.unmute = function(e) {
			if (e === undefined) {
				this.tracks_.audio.enabled = !0, this.tracks_.video.enabled = !0, this.gainNode_ !== undefined && (this.gainNode_.gain.value = 3);
				return
			}
			e.audio !== undefined && e.audio === !0 && (this.tracks_.audio.enabled = !0, this.gainNode_ !== undefined && (this.gainNode_.gain.value = 3)), e.video !== undefined && e.video === !0 && (this.tracks_.video.enabled = !0)
		}, n.prototype.startCall_ = function(e) {
			var t = this;
			for (var n in this.peers)(function(t) {
				if (e === !0) {
					if (!t.peers[n].screen_sender || t.peers[n].screen_sender.open) {
						var r = t.peer.call(n, t.screenStream, {
							metadata: {
								type: "screen"
							}
						});
						console.log("peer.call called from screenshare startCall_"), t.peers[n].screen_sender = r, t.setupStreamHandler_(r)
					}
				} else {
					var r = t.peer.call(n, t.stream);
					console.log("peer.call called from generic media exchange startCall_"), t.peers[n].call = r, t.setupStreamHandler_(r)
				}
			})(t);
			(!this.peer._events.call || this.peer._events.call.length === 0) && this.peer.on("call", function(e) {
				t.peers[e.peer] || (t.peers[e.peer] = {});
				if (e.metadata && e.metadata.type === "screen") t.peers[e.peer].screen_receiver = e, e.answer(), t.setupStreamHandler_(e);
				else {
					t.peers[e.peer].call = e, e.answer(t.stream), t.setupStreamHandler_(e);
					if (t.screenStream !== undefined) {
						var e = t.peer.call(e.peer, t.screenStream, {
							metadata: {
								type: "screen"
							}
						});
						t.peers[e.peer].screen_sender = e
					}
					console.log("peer.call called from call callback")
				}
			})
		}, n.prototype.setupStreamHandler_ = function(e) {
			var t = this,
				n = !!e.metadata && !!e.metadata.reconnect;
			e.on("stream", function(r) {
				e.metadata && e.metadata.type === "screen" ? (t.peers[this.peer].screen_receiver.stream = r, t.setupPeerScreen_(this.peer, r, n)) : (t.peers[this.peer].call.stream = r, t.setupPeerVideo_(this.peer, r, n))
			}).on("close", function() {
				var e = this.peer,
					n = this.metadata;
				t.listAllPeers(function(r) {
					var i = !0;
					for (var s in r)
						if (r[s] === e) {
							i = !1;
					...
					i && (n && n.type === "screen" ? t.fire_("ss_close", e) : t.fire_("ms_close", e), t.peers[e] && (t.peers[e].call === undefined || !t.peers[e].call.open) && (t.peers[e].DCconn === undefined || !t.peers[e].DCconn.open) && (t.peers[e].screen_sender === undefined || !t.peers[e].screen_sender.open) && t.removePeer(e))
				})
			})
		}, n.prototype.setupPeerVideo_ = function(e, t, n) {
			var r = window.URL.createObjectURL(t);
			n = !!n, this.peers[e].video = t, this.fire_("peer_ms", {
				id: e,
				src: r,
				reconnect: n
			})
		}, n.prototype.setupPeerScreen_ = function(e, t, n) {
			var r = this;
			n || (n = !1), r.peers[e].screen_receiver.video = t, r.fire_("peer_ss", {
				src: URL.createObjectURL(t),
				id: e,
				reconnect: n
			})
		}, n.prototype.removePeer = function(e) {
			try {
				if (this.peers[e] !== undefined) {
					var t = this.peers[e];
					t.call && t.call.close(), t.screen_sender && t.screen_sender.close(), t.screen_receiver && t.screen_receiver.close(), t.DCconn && t.DCconn.close()
				}
			} finally {
				delete this.peers[e]
			}
		}, n.prototype.startDataChannel_ = function() {
			this.startDCconnection_()
		}, n.prototype.startDCconnection_ = function() {
			var e = this;
			for (var t in this.peers) this.DCconnect_(t);
			this.peer.on("connection", function(t) {
				e.peers[t.peer] || (e.peers[t.peer] = {}), e.peers[t.peer].DCconn = t, e.setupDCHandler_(t), e.fire_("dc_open", t.peer)
			})
		}, n.prototype.DCconnect_ = function(e) {
			var t = this.peer.connect(e, {
				serialization: this.opts.serialization,
				reliable: this.opts.reliable
			});
			this.peers[e].DCconn = t, t.on("open", function() {
				this.setupDCHandler_(t), this.fire_("dc_open", t.peer)
			}.bind(this))
		}, n.prototype.setupDCHandler_ = function(e) {
			var t = this;
			e.on("data", function(e) {
				...
				t.listAllPeers(function(n) {
					...
					r && (t.fire_("dc_close", e), t.peers[e] && (t.peers[e].call === undefined || !t.peers[e].call.open) && (t.peers[e].DCconn === undefined || !t.peers[e].DCconn.open) && (t.peers[e].screen_sender === undefined || !t.peers[e].screen_sender.open) && t.removePeer(e))
				})
			})
		}, n.prototype.send_ = function(e) {
			if (!this.peer) return !1;
			if (e && typeof e == "string" && e.length === 0) return !1;
			if (e && (typeof e == "string" || typeof e == "object"))
				for (var t in this.peers) this.peers[t].DCconn && this.peers[t].DCconn.send(e)
		}, n.prototype.fire_ = function(e, t) {
			this.emit(e, t)
		}, n.util = {}, n.util.checkOpts_ = function(e) {
			var t = {};
			if (!e.key || typeof e.key != "string") throw "app key must be specified";
			if (!e.key.match(/^[0-9a-z]{8}\-[0-9a-z]{4}\-[0-9a-z]{4}\-[0-9a-z]{4}\-[0-9a-z]{12}$/)) throw "wrong string pattern of app key";
			t.key = e.key;
			if (!e.room || typeof e.room != "string") var r = "";
			else {
				if (!e.room.match(/^[0-9a-zA-Z\-\_]{4,32}$/)) throw "room name should be digit|alphabet and length between 4 and 32";
				var r = e.room
			}
			t.room_name = r, t.room_id = n.util.makeRoomName(r);
			var i = location.pathname + "_peer_id";
			return sessionStorage[i] ? t.id = sessionStorage[i] : !e.id || typeof e.id != "string" ? t.id = t.room_id + n.util.makeID() : t.id = t.room_id + e.id, sessionStorage[i] = t.id, e.reliable ? t.reliable = !0 : t.reliable = !1, e.serialization ? t.serialization = e.serialization : t.serialization = "binary", t.video_stream = e.video === undefined ? !0 : e.video, t.audio_stream = e.audio === undefined ? !0 : e.audio, t.use_stream = t.video_stream || t.audio_stream, t.polling = e.polling === undefined ? !0 : e.polling, t.polling_interval = e.polling_interval === undefined ? 3e3 : e.polling_interval, t.peerjs_opts = {
				debug: e.debug || !1,
				key: t.key
			}, e.host && (t.peerjs_opts.host = e.host), e.port && (t.peerjs_opts.port = e.port), e.secure && (t.peerjs_opts.secure = e.secure), e.config && (t.peerjs_opts.config = e.config), t
		}, n.util.makeID = function() {
			var e = "";
			for (var t = 0; t < 32; t++) e += String.fromCharCode(Math.random() * 9 + 48 | 0);
			return e
		}, n.util.makeRoomName = function(e) {
			return e = e || "", e += location.host + location.pathname, t.MD5.calc(e).substring(0, 6) + "R_"
		}, n.util.createVideoNode = function(e) {
			var t = document.getElementById(e.id);
			t && t.parentNode.removeChild(t);
			var n = document.createElement("video");
			n.setAttribute("src", e.src), n.setAttribute("id", e.id);
			var r = !1;
			return n.addEventListener("loadedmetadata", function(e) {
				r || (r = !0, this.play())
			...
			this.peer && this.send_(e)
		}, n.prototype.close = function() {
			this.peer && this.peer.destroy(), clearInterval(this.pollInterval)
		}, n.prototype.startScreenShare = function(e, t) {
			if (this.peer) {
				var n = this;
				if (SkyWay && SkyWay.ScreenShare) {
					...
					r.isEnabledExtension() && r.startScreenShare({
						...
						n.screenStream = t, n.startCall_(!0), util.log("MediaConnection created in OFFER"), e(t)
					}, t)
				}
			}
			...
			if (this.screenStream) {
				...
				for (var e in this.peers) this.peers[e].screen_sender && this.peers[e].screen_sender.close(), delete this.peers[e].screen_sender;
				this.screenStream = undefined
			}
		}, n.prototype.listAllPeers = function(e) {
			var t = this;
			this.peer.listAllPeers(function(n) {
				var r = [];
				n.forEach(function(e) {
					e !== t.opts.id && e.indexOf(t.opts.room_id) === 0 && r.push(e)
				}), e(r)
			})
		}, n.prototype.reconnect = function(e, t) {
			var n = this,
				r = n.peers[e];
			t === undefined && (t = {
				video: !0,
			...
			if (r) {
				if (t.video) {
					r.call && r.call.close && r.call.close();
					var i = n.peer.call(e, n.stream, {
						metadata: {
							reconnect: !0
						}
					});
					console.log("peer.call called from reconnect method"), r.call = i, n.setupStreamHandler_(i)
				}
				if (t.screen && n.screenStream) {
					r.screen_sender && r.screen_sender.close && r.screen_sender.close();
					var i = n.peer.call(e, n.screenStream, {
						metadata: {
							reconnect: !0,
							type: "screen"
						}
					});
					console.log("peer.call called from reconnect method in screenshare"), r.screen_sender = i
				}
				if (t.data) {
					r.DCconn && r.DCconn.close && r.DCconn.close();
					var s = this.peer.connect(e, {
						serialization: this.opts.serialization,
						reliable: this.opts.reliable,
						metadata: {
							reconnect: !0
						...
						r.DCconn = s, n.setupDCHandler_(s)
					})
				}
			}
		}, e.MultiParty || (e.MultiParty = n)
	}(window)
})(this)
