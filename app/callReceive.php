...
<body>
	...
	<div id="permitButtonDiv">
		<input type="button" value="出る" id="trueButton" onclick="callPermit();" class="tuio-tapEvent">
		<input type="button" value="出ない" id="cancelButton" onclick="callCancel();" class="tuio-tapEvent">
	</div>
<?php $yumDB->close() ?>
