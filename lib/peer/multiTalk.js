...
function makeCall(callTo) {
	...
	callToPhoneNumber = callTo;
}

/**
 * 誰にかけるかを返すメソッド
 * @param callTo
 * @returns かける相手のphone_number
 */
function returnCallTo () {
	return callToPhoneNumber;
}
 ...
 */
function cntDownStart() {
	console.log('スタート時点で : ' + timer);
	timerFunc = setInterval('cntDown(callObject)', 1000);
}
